...
namespace Crawer.Jobs
{
    ...
    public class QQ_Page_Job_Free:IJob
    {
        ...
        private static int QQChapterTotal = 0;
        private static int QQChapterIndex = 0;
        public QQ_Page_Job_Free()
        {
            dbcontext = new MsSqlContext("Mssql".ValueOfAppSetting());
            string strQQChapterTotal = "QQChapterTotal".ValueOfAppSetting();
            string strQQChapterIndex = "QQChapterIndex".ValueOfAppSetting();
            if (strQQChapterTotal != null && strQQChapterIndex != null && int.TryParse(strQQChapterTotal, out QQChapterTotal) && int.TryParse(strQQChapterIndex, out QQChapterIndex))
            {
            }
        }
